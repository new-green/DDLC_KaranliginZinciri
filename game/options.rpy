...
define config.name = "DDLC Karanlığın Zinciri"
...
define build.name = "KaranliginZinciri"
...
init python:
    ...
    build.classify("game/natsuki_custom/***", "mod_assets all")
    build.classify("game/sayori_custom/***", "mod_assets all")
    build.classify("game/background/***", "mod_assets all")
    build.classify("game/sfx/***", "mod_assets all")
    build.classify("game/natsuki_custom/***", "script all")
    build.classify("game/sayori_custom/***", "script all")
    build.classify("game/background/***", "script all")
    build.classify("game/sfx/***", "script all")
    build.classify("game/mod_assets/***", "mod_assets all")
    build.classify("game/mod_assets/menu/**", "mod_assets all")
