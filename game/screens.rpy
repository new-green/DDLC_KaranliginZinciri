...
define -2 text_outline_color = "#AAAAAB"
...
style frame:
    ...
    background Frame("mod_assets/menu/frame.png", gui.frame_borders, tile=gui.frame_tile)
...
style window:
    ...
    background Transform("mod_assets/menu/textbox.png", xalign=0.5, yalign=1.0)
...
style namebox:
    ...
    background Frame("mod_assets/menu/namebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
        ...
        for i in items:
            ...
            if "kwargs=" in i.caption:
                ...
                if "#" in kwarg:
                    ...
                    textbutton caption:
                        idle_background Frame(im.MatrixColor(im.MatrixColor("mod_assets/menu/choise_idle_bg.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#00f", "#fff") * im.matrix.saturation(120)), 
                            im.matrix.desaturate() * im.matrix.colorize(arg1, arg2)), gui.choice_button_borders)
                        hover_background Frame(im.MatrixColor(im.MatrixColor("mod_assets/menu/choise_idle_bg.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#00f", "#fff") * im.matrix.saturation(120)), 
    ...
    vbox:
        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                textbutton _("Kayıtlı Oyun") action [ShowMenu("save"), SensitiveIf(renpy.get_screen("save") == None)]
            ...
            if renpy.variant("pc"):
                ...
                textbutton _("Kapat") action Quit(confirm=not main_menu)
        else:
...
style navigation_button_text:
    ...
    hover_outlines [(4, "#6d6d6d", 0, 0), (2, "6d6d6d", 2, 2)]
    insensitive_outlines [(4, "6d6d6d", 0, 0), (2, "6d6d6d", 2, 2)]
...
style game_menu_outer_frame:
    ...
    background "mod_assets/menu/menu.png"
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                ...
                text "{b}{a=https://discord.com/invite/dokitale}DokiTale {/a}Discord Sunucusuna Teşekkürler{/b}\n"
                text _("Bizler, Modumu hayata geçirmek için desteklerini esirgemeyen {a=https://discord.com/invite/dokitale}DokiTale Discord{/a} Sunucusu üyelerine teşekkür ederiz. Projemizin başarılı olmasında katkıları olan herkese minnettarız.")
                text "{b}Teşekürler: {/b}\n"
                text "{b}xketum{/b}: Hikaye yazımı konusundaki yaratıcılığı ve emeği için teşekkür ederiz."
                text "{b}goddessaquasama{/b}:  Karakter ve arka plan tasarımlarındaki profesyonel yaklaşımıyla projemize değer kattığınız için teşekkür ederiz."
                text "{b}korayxby{/b}: Sürekli desteğiniz ve motivasyonunuz için teşekkür ederiz."
                text "{b}the.ro3wy{/b}: Renk paleti, Kullanıcı arayüzünde ve logo tasarımında ortaya koyduğunuz yetenek ve özgün fikirler için teşekkür ederiz."
                text "{b}new_green{/b}: Proejenin sahibi sayılırım. Script yazımında ve hikaye düzenlemesinde yardımcı oldum. Ayrıca yüksek ilgi ve alakası için {b}gizmo{/b}'e de teşekkür ederim."
                ...
                text ("\n\nbronya_rands'ın {a=https://github.com/GanstaKingofSA/DDLCModTemplate2.0}DDLC Mod Template 2.0{/a}.\nTelif hakkı © 2019-" + str(datetime.date.today().year) + " Azariel Del Carmen (bronya_rand). Tüm hakları saklıdır.\n")
                text "Doki Doki Literature Club. Telif hakkı © 2017 Team Salvato. Tüm hakları saklıdır"
                text _("{a=https://www.renpy.org/}Ren'Py{/a} kullanıldı. [renpy.version_only]")

## This is redefined in options.rpy to add text to the about screen.
define gui.about = "0.1"
...
screen ddlc_preferences():
    ...
    hbox:
        ...
        vbox:
            ...
            bar value FieldValue(_preferences, "text_cps", range=200, max_is_zero=False, style="slider", offset=20)

            hbox:
                label _("Oto-ileri zamanı")
...
style pref_label_text:
    ...
    size 24
    color "#fff"
    outlines [(3, "#838383ff", 0, 0), (1, "#6d6d6d", 1, 1)]
    yalign 1.0
...
screen history():
    ...
    use game_menu(_("Geçmiş"), scroll=("vpgrid" if gui.history_height else "viewport")):
...
style confirm_frame:
    background Frame("mod_assets/menu/frame.png", gui.confirm_frame_borders, tile=gui.frame_tile)
