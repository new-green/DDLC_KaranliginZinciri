...
label start:
    ...
    scene black
    play music t2 fadein 0.5
    show monika 1b zorder 2 at h11
    m "Hey [player]!"
    m "Geri döndün!!!"
    menu:
        dev "[player]! Hoşgeldin. Bir önceki hikayeyi okudun mu?"
        "Evet":
            dev "Mükemmel! [player]."
            m "O zaman hadi devam edelim!"
        "Hayır":
            show monika 2f zorder 1 at d11
            m "Ah be"
            dev "O zaman hikayeyi baştan dinlemen gerekiyor."
            m "Zaman kaybedeceğiz."
            m "Ama olsun {w=0.5}başlayalım."
            call story_ch1 from _call_story_ch1
    
    call story_ch2 from _call_story_ch2
